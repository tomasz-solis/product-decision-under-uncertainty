...
staged gates, or options that make later options possible. The four-option frame is
...
falls back to EV. That fallback should be stated explicitly in any review - it means the team is operating outside safe bounds and the decision carries
