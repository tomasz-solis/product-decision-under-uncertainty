...
This section puts a euro figure on which uncertainty is worth resolving before
the decision is made. EVPI is the value of resolving everything; EVPPI is the
value of resolving one parameter on its own. It is the quantified version of the
"what should we measure first?" question raised in [NARRATIVE.md](NARRATIVE.md).
